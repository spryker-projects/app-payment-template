 ...
 */
class ApiRequestHeaderValidatorPlugin extends AbstractPlugin implements RequestValidatorPluginInterface
{
    /**
     * {@inheritDoc}
     * - Checks if X-Store-reference is present in headers
     *
     * @api
     *
    ...
    {
        return $this->getFactory()->createApiRequestHeaderValidator()->validate($glueRequestTransfer);
    }
}
