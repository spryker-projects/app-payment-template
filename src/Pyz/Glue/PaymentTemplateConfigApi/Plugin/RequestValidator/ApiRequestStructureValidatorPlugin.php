 ...
 */
class ApiRequestStructureValidatorPlugin extends AbstractPlugin implements RequestValidatorPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFactory()->createApiRequestStructureValidator()->validate($glueRequestTransfer);
    }
}
